...
if (!isseT($_POST['idpost'])) {
	...
	$accion_addpost = sprintf("INSERT INTO posts(title, category, content,image,autor,seo) VALUES (%s,%s,%s,%s,%s,%s)",
	...
	$accion_editar = sprintf("UPDATE posts SET title=%s,category=%s,content=%s , image=%s,seo=%s WHERE id=%s",
		formatearcadena($_POST['titulo'], 'text'),
		formatearcadena($_POST['categoria'], 'int'),
		formatearcadena($_POST['contenido'], 'text'),
